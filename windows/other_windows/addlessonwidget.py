...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QPushButton, QLineEdit, QHBoxLayout, QComboBox, QCheckBox

# Окно параметров для аудитории (препод, нужны ли: комп, проектор)

class AddingLessonWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.massive = []
    ...
    def addLine(self):
        ...
        line.group.setMinimumWidth(50)
        line.teacher_name = QComboBox()
        line.teacher_name.setMinimumWidth(150)
        line.name = QLineEdit()
        ...
        line_layout.addWidget(line.teacher_name)
